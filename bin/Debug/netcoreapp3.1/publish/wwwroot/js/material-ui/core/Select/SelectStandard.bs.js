...
function borderTopBottoms(borderTopBottom) {
  if (borderTopBottom !== undefined) {
    return borderTopBottom + "px";
  } else {
    return "10px";
  }
}
...
function SelectStandard(Props) {
  ...
  var tmp = {
    ...
    style: Object.assign(({}), {
          ...
          paddingTop: borderTopBottoms(borderTop),
          paddingBottom: borderTopBottoms(borderBottom),
          width: "auto"
