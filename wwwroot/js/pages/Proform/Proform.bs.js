...
function Proform(Props) {
  ...
  var barShowRestoreAction = function (youtubeText) {
    Curry._1(dispatch, /* ActionSnackBar */Block.__(49, [
            youtubeText,
            true
          ]));
    setTimeout((function (param) {
            return Curry._1(dispatch, /* ActionSnackBar */Block.__(49, [
                          "",
                          false
                        ]));
          }), 5000);
  ...
  var changeFormDesc = React.useCallback((function (value) {
          return Curry._1(dispatch, /* ChangeFormDesc */Block.__(11, [value]));
        }));
  var sLimitAJax = function (i) {
    Axiosapi$BtsCore.Proform.sLimit(Data$BtsCore.dFormData(state.formId, localStorage.getItem("newid"))).then((function (response) {
              return Promise.resolve((Curry._1(dispatch, /* AddDert */Block.__(45, [
                                  i,
                                  response.data.items
                                ])), Curry._1(dispatch, /* ActionShowProgress */2)));
            })).catch((function (error) {
  ...
  var clickFormTab = React.useCallback((function (i) {
          Curry._1(dispatch, /* ClickFormTab */Block.__(12, [i]));
  ...
  var clickBoardPaper = React.useCallback((function (i) {
          return Curry._1(dispatch, /* ClickBoardPaper */Block.__(13, [i]));
        }));
  var changeTile = React.useCallback((function (value) {
          return (function (i) {
              return Curry._1(dispatch, /* ChangeTile */Block.__(14, [
                            value,
                            i
                          ]));
            });
  ...
  var showOut = React.useCallback((function (i) {
          return Curry._1(dispatch, /* ShowOut */Block.__(15, [i]));
        }));
  var showValue = React.useCallback((function (value) {
          return (function (i) {
              return Curry._1(dispatch, /* ShowValue */Block.__(16, [
                            value,
                            i
                          ]));
            });
  ...
  var changeText = React.useCallback((function (value) {
          return (function (ri, i) {
              return Curry._1(dispatch, /* ChangeText */Block.__(17, [
                            value,
                            ri,
                            i
                          ]));
  ...
  var clickElement = React.useCallback((function (value) {
          return (function (ri, i) {
              if (value === "checkbox") {
                return Curry._1(dispatch, /* ClickCheckbox */Block.__(19, [
                              ri,
                              i
                            ]));
              } else {
                return Curry._1(dispatch, /* ClickRadio */Block.__(18, [
                              ri,
                              i
                            ]));
              }
  ...
  var clearOption = React.useCallback((function (ri) {
          return (function (i) {
              return Curry._1(dispatch, /* ClearOption */Block.__(20, [
                            ri,
                            i
                          ]));
            });
  ...
  var showType = React.useCallback((function (i) {
          return Curry._1(dispatch, /* ShowType */Block.__(21, [i]));
        }));
  var clickType = React.useCallback((function (type_) {
          return (function (i) {
              Axiosapi$BtsCore.Proform.sType(Data$BtsCore.sRowsData(state.formId, i, localStorage.getItem("newid"))).then((function (response) {
                        ...
                        var tmp;
                        if (match === "istrue") {
                          tmp = Curry._1(dispatch, /* ClickType */Block.__(22, [
                                  i,
                                  response.data.value,
                                  response.data.items,
                                  type_
                          ...
                          barShowRestoreAction(Status$BtsCore.statusModule(response.data.status));
                          tmp = Curry._1(dispatch, /* ClearCondition */Block.__(27, [type_]));
                        }
                        return Promise.resolve(tmp);
                      })).catch((function (error) {
                      return Promise.resolve((console.log(error), undefined));
  ...
  var showOperation = React.useCallback((function (i) {
          return Curry._1(dispatch, /* ShowOperation */Block.__(23, [i]));
        }));
  var clickOperation = React.useCallback((function (operation) {
          return (function (i) {
              return Curry._1(dispatch, /* ClickOperation */Block.__(24, [
                            operation,
                            i
                          ]));
            });
  ...
  var changeArea = React.useCallback((function (area) {
          return (function (i) {
              return Curry._1(dispatch, /* ChangeArea */Block.__(25, [
                            area,
                            i
                          ]));
            });
  ...
  var changeEror = React.useCallback((function (area) {
          return (function (i) {
              return Curry._1(dispatch, /* ChangeEror */Block.__(26, [
                            area,
                            i
                          ]));
            });
  ...
  var clearCondition = React.useCallback((function (i) {
          return Curry._1(dispatch, /* ClearCondition */Block.__(27, [i]));
        }));
  var showMore = React.useCallback((function (i) {
          return Curry._1(dispatch, /* ShowMore */Block.__(28, [i]));
        }));
          ...
          return (function (showVeri, i) {
              if (showVeri) {
                ...
                Axiosapi$BtsCore.Proform.sVeri(Data$BtsCore.sRowsData(state.formId, i, localStorage.getItem("newid"))).then((function (response) {
                          ...
                          var tmp;
                          if (match === "istrue") {
                            tmp = Curry._1(dispatch, /* ShowItemVerification */Block.__(29, [
                                    response.data.type_,
                            ...
                            barShowRestoreAction(Status$BtsCore.statusModule(response.data.status));
                            tmp = Curry._1(dispatch, /* ClearCondition */Block.__(27, [id]));
                          }
                          return Promise.resolve(tmp);
                        })).catch((function (error) {
                        return Promise.resolve((console.log(error), undefined));
  ...
  var checkItem = React.useCallback((function (i) {
          return Curry._1(dispatch, /* CheckItem */Block.__(30, [i]));
        }));
  var deleteItem = React.useCallback((function (i) {
          return Curry._1(dispatch, /* DeleteItem */Block.__(31, [i]));
        }));
  var addItem = React.useCallback((function (i) {
          return Curry._1(dispatch, /* AddItem */Block.__(32, [i]));
        }));
  ...
  var addForm = React.useCallback((function (param) {
          ...
          Axiosapi$BtsCore.Proform.add(Data$BtsCore.userData(localStorage.getItem("newid"))).then((function (response) {
                    return Promise.resolve((Curry._1(dispatch, /* AddForm */Block.__(33, [response.data.items])), Curry._1(dispatch, /* ActionShowProgress */2)));
                  })).catch((function (error) {
                  return Promise.resolve((console.log(error), undefined));
                }));
  ...
  var deleteForm = React.useCallback((function (param) {
          ...
          Axiosapi$BtsCore.Proform.$$delete(Data$BtsCore.dFormData(state.formId, localStorage.getItem("newid"))).then((function (response) {
                    ...
                    var tmp;
                    if (match === "istrue") {
                      Curry._1(dispatch, /* DeleteForm */Block.__(34, [state.formId]));
                      Curry._1(dispatch, /* CloseAnimationFull */6);
  ...
  var changeStdate = React.useCallback((function (value) {
          return (function (i) {
              return Curry._1(dispatch, /* ChangeStdate */Block.__(35, [
                            value,
                            i
                          ]));
            });
  ...
  var changeSttime = React.useCallback((function (value) {
          return (function (i) {
              return Curry._1(dispatch, /* ChangeSttime */Block.__(36, [
                            value,
                            i
                          ]));
            });
  ...
  var changeEndate = React.useCallback((function (value) {
          return (function (i) {
              return Curry._1(dispatch, /* ChangeEndate */Block.__(37, [
                            value,
                            i
                          ]));
            });
  ...
  var changeEntime = React.useCallback((function (value) {
          return (function (i) {
              return Curry._1(dispatch, /* ChangeEntime */Block.__(38, [
                            value,
                            i
                          ]));
            });
  ...
  var showExam = React.useCallback((function (i) {
          return Curry._1(dispatch, /* ShowExam */Block.__(39, [i]));
        }));
  var randOption = React.useCallback((function (i) {
          return Curry._1(dispatch, /* RandOption */Block.__(40, [i]));
        }));
  var randSubtile = React.useCallback((function (i) {
          return Curry._1(dispatch, /* RandSubtile */Block.__(41, [i]));
        }));
  var showRestart = React.useCallback((function (i) {
          return Curry._1(dispatch, /* ShowRestart */Block.__(42, [i]));
        }));
  var changeNumber = React.useCallback((function (value) {
          return (function (i) {
              return Curry._1(dispatch, /* ChangeNumber */Block.__(43, [
                            value,
                            i
                          ]));
            });
  ...
  var showLimit = React.useCallback((function (value) {
          return (function (i) {
              Curry._1(dispatch, /* ShowLimit */Block.__(44, [i]));
              if (!value) {
                Curry._1(dispatch, /* ActionShowProgress */2);
                return sLimitAJax(i);
              }
  ...
  var showPanel = React.useCallback((function (value) {
          return (function (i, di, items) {
              Curry._1(dispatch, /* ShowPanel */Block.__(46, [
                      i,
                      di
                    ]));
              if (items.length === 0) {
                Axiosapi$BtsCore.Proform.sOper(Data$BtsCore.sRowsData(state.formId, value, localStorage.getItem("newid"))).then((function (response) {
                          return Promise.resolve(Curry._1(dispatch, /* AddOper */Block.__(47, [
                                            i,
                                            di,
                                            response.data.items
                                          ])));
  ...
  var showOper = React.useCallback((function (i) {
          return (function (di, oi) {
              return Curry._1(dispatch, /* ShowOper */Block.__(48, [
                            i,
                            di,
                            oi
                          ]));
