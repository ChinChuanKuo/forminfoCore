...
import * as YoutubeForget$BtsCore from "../../example/Account/Forget/YoutubeForget.bs.js";
...
function Forget(Props) {
  ...
  var changeBirthday = React.useCallback((function (value) {
          return Curry._1(dispatch, /* ChangeBirthday */Block.__(0, [value]));
        }));
  ...
  var forgetUserAJax = function (param) {
    Axiosapi$BtsCore.Forget.forgetUser(Data$BtsCore.otherData(sessionStorage.getItem("newid"), state.birthday)).then((function (response) {
              var match = response.data.status;
              var tmp;
              switch (match) {
                case "istrue" :
                    tmp = ReasonReactRouter.push(Path$BtsCore.codePath);
                    break;
                case "nousers" :
                    tmp = ReasonReactRouter.push(Path$BtsCore.loginPath);
                    break;
  ...
  var keydownBirthday = React.useCallback((function (keyCode) {
          if (keyCode === 13) {
            ...
            return forgetUserAJax(undefined);
          }
  ...
  return React.createElement(YoutubeForget$BtsCore.make, {
              error: state.error,
              loading: state.loading,
              showYoutube: state.showYoutube,
              youtubeText: state.youtubeText,
